export const USERS_MESSAGES = {
  ...
  IMAGE_URL_LENGTH: 'image length must be between 1 and 400',
  ...
  USERNAME_INVALID:
    'Username must be 4-15 characters long, must start with a letter, and can only contain letters, numbers, and underscores.',
